...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  lun. 23 mars 2020 à 12:07
...
(107, '2020-03-11 14:52:23', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '1970-01-01 01:00:00', 'Session expirée', 1),
(108, '2020-03-12 00:36:33', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '1970-01-01 01:00:00', 'Session expirée', 1),
(109, '2020-03-12 12:30:11', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '1970-01-01 01:00:00', 'Session expirée', 1),
(110, '2020-03-14 11:45:16', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '1970-01-01 01:00:00', 'Session expirée', 1),
(111, '2020-03-14 15:11:00', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '1970-01-01 01:00:00', 'Session expirée', 1),
(112, '2020-03-15 09:08:51', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '2020-03-15 10:19:50', 'Session fermée correctement', 1),
(113, '2020-03-15 10:19:52', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '1970-01-01 01:00:00', 'Session expirée', 1),
(114, '2020-03-17 11:29:51', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '1970-01-01 01:00:00', 'Session expirée', 1),
(115, '2020-03-17 17:09:32', '127.0.0.1', 'DESKTOP-P44FHNR', 'Session en cours', NULL, '', 1),
(116, '2020-03-20 13:31:20', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '1970-01-01 01:00:00', 'Session expirée', 1),
(117, '2020-03-21 11:06:04', '127.0.0.1', 'DESKTOP-P44FHNR', 'Connexion réussi', '1970-01-01 01:00:00', 'Session expirée', 1),
(118, '2020-03-23 12:31:00', '127.0.0.1', 'DESKTOP-P44FHNR', 'Session en cours', NULL, '', 1);
...
INSERT INTO `groupemenu` (`grpid`, `grplibelle`, `grpicone`, `url`, `grporder`, `active`) VALUES
(1, 'Produit', '<i class=\"fa fa-book\"></i> ', 'produit', 1, 1),
(2, 'Commande produits', '<i class=\"fa fa-shopping-basket\"></i>', 'commande', 3, 1),
(3, 'Livraison', '<i class=\"fa fa-cart-arrow-down\"></i> ', 'livraison', 2, 1),
(4, 'Stock', '<i class=\"fa fa-database\"></i>', 'stock', 4, 1),
(5, 'Statistique', '<i class=\"fa fa-pie-chart\"></i>', 'statistique', 8, 1),
(6, 'Administration', '<i class=\"fa fa-cog\"></i>', 'parametre', 9, 1),
(7, 'Fournisseur', '<i class=\"fa fa-user\"></i>', 'fournisseur', 6, 1),
(8, 'Client', '<i class=\"fa fa-user\"></i>', 'client', 7, 1),
(9, 'Mouvement', '<i class=\"fa fa-car\"></i>', 'mouvement', 5, 0),
(10, 'Offshore', '<i class=\"fa fa-file-o\"></i>', 'offshore', 10, 1),
(11, 'Email', '<i class=\"fa fa-send\"></i>', 'email', 11, 1);
...
CREATE TABLE IF NOT EXISTS `livraisons` (
  ...
  `livproduit` int(11) NOT NULL,
  `livquantite` float NOT NULL,
  `description` text,
  `livree` int(11) DEFAULT '1' COMMENT '0 si on effectue une livraison complete ',
  `livrealiserpar` int(11) NOT NULL,
  `livoffre` int(11) NOT NULL,
  PRIMARY KEY (`livid`),
  KEY `fk_mouvements_users1_idx` (`livrealiserpar`),
  KEY `fk_mvtoffre` (`livoffre`) USING BTREE,
  KEY `mvtproduit` (`livproduit`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;
...
INSERT INTO `livraisons` (`livid`, `livdate`, `livproduit`, `livquantite`, `description`, `livree`, `livrealiserpar`, `livoffre`) VALUES
(1, '2020-03-21 17:10:19', 62, 10000, NULL, 1, 1, 1),
(2, '2020-03-21 17:10:19', 70, 5000, NULL, 1, 1, 4),
(3, '2020-03-21 17:10:19', 70, 6000, NULL, 1, 1, 3),
(4, '2020-03-21 22:43:11', 65, 14552, NULL, 1, 1, 1),
(5, '2020-03-21 22:43:11', 70, 1500, NULL, 1, 1, 2);
...
(5, 'Effectuer une livraison', 'vente/add', '', 3, 301, 1),
(6, 'Mes livraisons', 'vente/mesventes', '', 3, 304, 1),
(7, 'Toutes les livraisons', 'livraison', '', 3, 305, 0),
...
(24, 'Mouvement chargement', 'mouvement', '', 9, 901, 1),
(25, 'Mouvement magasin', 'magasin/mouvement', '', 9, 902, 1),
...
(2, '2020-03-15 09:55:00', '2020-03-15 08:55:08', NULL, 0, 1, 1, 1),
(3, '2020-03-15 09:55:00', '2020-03-15 08:55:47', NULL, 0, 1, 1, 1),
(4, '2020-03-15 10:20:00', '2020-03-15 09:20:05', NULL, 0, 1, 1, 1),
(5, '2020-03-24 00:00:00', '2020-03-21 21:55:20', NULL, 0, 2, 1, 1);
